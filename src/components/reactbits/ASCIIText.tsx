...
class CanvAscii {
  ...
  updateRotation() {
    // Tuned for a livelier response: wider rotation range and a
    // quicker follow toward the cursor.
    const x = map(this.mouse.y, 0, this.height, 0.72, -0.72);
    const y = map(this.mouse.x, 0, this.width, -0.72, 0.72);
