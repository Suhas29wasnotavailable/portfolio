...
export interface TargetCursorProps {
  ...
  /**
   * When true, the cursor effect only appears while hovering a target:
   * the system cursor stays normal elsewhere, and the brackets fade in
   * (hiding the system cursor) only over `targetSelector` elements.
   */
  activeOnly?: boolean;
}
...
const TargetCursor: React.FC<TargetCursorProps> = ({
  ...
  useEffect(() => {
    ...
    if (hideDefaultCursor && !activeOnly) {
    ...
    const enterHandler = (e: MouseEvent) => {
      ...
      if (activeOnly) {
        // reveal the effect only now, and take over from the system cursor
      ...
      const leaveHandler = () => {
        ...
        if (activeOnly) {
          // hand back to the system cursor
